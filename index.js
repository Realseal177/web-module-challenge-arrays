...
*/
// 2 params - array  / number (holding the place for an index)
...
console.log('taks 7', filterByWord(originalFlavors, 'Chocolate'));
...
*/
// uncomment the data and move it about the function
